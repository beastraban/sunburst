...
class DashboardClient:
    ...
    async def _connect(self):
        ...
        try:
            ...
            print(f"[Dashboard] Connected to server at {self.uri}")
    ...
    async def _send(self, message: str):
        ...
        await self._connect()  # Ensure connected
        if self._connection:
            try:
    ...
    def _sync_send(self, msg_type: str, data: dict):
        ...
        try:
            ...
            try:
                ...
                # This shouldn't happen in normal sync code
                asyncio.ensure_future(self._send(message))
            except RuntimeError:
                # No running loop - create or get one
                try:
            ...
            print(f"[Dashboard] Error sending: {e}")
